        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter =
                new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                        ...
                        int oneTypeProductPrice = Integer.parseInt(priceString);
                        int quantity = Integer.parseInt(model.getQuantity());
                        holder.txtProductPrice.setText("Price = " + priceString + " Rs.");
                        holder.txtProductName.setText(model.getPname());
                        int oneTypeProductTotalPrice = oneTypeProductPrice * quantity;
